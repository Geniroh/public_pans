...
<body>
    <form class="form-signin" action="includes/reset_request.php" method="post">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="reset_request_submit">Receive New Password By Mail</button>
